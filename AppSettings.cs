...
namespace ImageBrowser
{
    public class AppSettings
    {
        ...
        // ── 习惯设置 ──────────────────────────────────────────────────────
        public bool   MultiWindow         { get; set; } = true;
        ...
        public bool   UseExplorerSort     { get; set; } = true;     // 使用资源管理器排序

        // ── 显示设置（与主窗口更多菜单同步） ──────────────────────────────
        public bool ShowThumbnails  { get; set; } = true;
        public bool SmartThumbnails { get; set; } = false;
        public bool ShowBirdEye     { get; set; } = false;
        public bool FolderTraverse  { get; set; } = true;
