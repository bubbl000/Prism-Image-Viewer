...
namespace ImageBrowser
{
    public partial class SettingsWindow : Window
    {
        ...
        private void LoadSettings()
        {
            ...
            ChkThumbStrip.IsChecked     = s.ShowThumbnails;
            ChkSmartDisplay.IsChecked   = s.SmartThumbnails;
            ChkBirdEye.IsChecked        = s.ShowBirdEye;
            ChkFolderTraverse.IsChecked = s.FolderTraverse;
        ...
        private void ChkThumbStrip_Changed(object sender, RoutedEventArgs e)
        {
            if (_loading) return;
            AppSettings.Current.ShowThumbnails = ChkThumbStrip.IsChecked == true;
            AppSettings.Current.Save();
            _mainWindow.ApplyThumbStripVisibility(AppSettings.Current.ShowThumbnails);
        }

        private void ChkSmartDisplay_Changed(object sender, RoutedEventArgs e)
        {
            if (_loading) return;
            AppSettings.Current.SmartThumbnails = ChkSmartDisplay.IsChecked == true;
            AppSettings.Current.Save();
        }

        private void ChkBirdEye_Changed(object sender, RoutedEventArgs e)
        {
            if (_loading) return;
            AppSettings.Current.ShowBirdEye = ChkBirdEye.IsChecked == true;
            AppSettings.Current.Save();
            _mainWindow.ApplyBirdEyeVisibility(AppSettings.Current.ShowBirdEye);
        }

        private void ChkFolderTraverse_Changed(object sender, RoutedEventArgs e)
        {
            if (_loading) return;
            AppSettings.Current.FolderTraverse = ChkFolderTraverse.IsChecked == true;
            AppSettings.Current.Save();
        }
